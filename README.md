...
- ✅ Actively practicing **technical & HR interview preparation**
...
- React.js (Hooks, Components, Props, State, API Integration)

### 🔹 Backend & Databases
- Java (Core, JDBC, Servlets, JSP)  
- Spring Boot (Basic REST APIs)  
- MySQL (CRUD, Joins, Constraints, Normalization)  
- Firebase (Basics)
...
- Project showcase, contact section, downloadable CV  
...
> *“Consistent learning, real-world projects, and problem-solving mindset define my journey as a developer.”*
